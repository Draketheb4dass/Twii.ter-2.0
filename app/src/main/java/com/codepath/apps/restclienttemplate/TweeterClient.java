...
public class TweeterClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "b6yrgSyZUZbcERN5rexkUxK8w";
    ...
    public void getMentionsTimeline(AsyncHttpResponseHandler handler) {
        String apiUrl =
                getApiUrl("statuses/mentions_timeline.json");
        // Can specify query string params directly or through RequestParams.
        RequestParams params = new RequestParams();
        params.put("count", 25);
        params.put("since_id", 1);
	...
	public  void postStatus(AsyncHttpResponseHandler handler,long tweetId, String status) {
    ...
    public void postLike(AsyncHttpResponseHandler handler, long tweetId){
    ...
    public void postUnlike(AsyncHttpResponseHandler handler, long tweetId) {
        RequestParams params = new RequestParams();
        params.put("id", tweetId);
